...
- `Artificial Intelligence (AI) Agent Frameworks:` LangGraph, LlamaIndex, Model Context Protocol (MCP), Smolagents
...
- `Machine Learning (ML) / Data Science:` Anomaly Detection of Time Series Data, Brier Score, Classification, Clustering (DBSCAN, K-means, K-nearest neighbors), Data Sampling, Dimensionality Reduction (Latent Spaces, Linear Discriminant Analysis (LDA) Principal Component Analysis (PCA)), Dropout, Exploratory Data Analysis, imblearn, Linear Regression, Natural Language Processing (NLP), Quantile Regression, Random Forests, Sentiment Analysis, SHAP, SMOTE, Time Series Analysis, Tuning, XGBoost
...
| [AI Model Compression: Knowledge Distillation, Pruning, and Quantization](https://github.com/beenlanced/ai_model_compression.git)                                                      | CNN<br>Deep Learning<br>Github<br>Fine-Tuning<br>Knowledge-Distillation<br>Jupyter<br>Pruning<br>Python<br>PyTorch<br>Quantization<br>Tensors<br>uv                                                                                                            |               |    | LinkedIn Learning Module |
| [Model Context Protocol Servers](https://github.com/beenlanced/ai_mcp_server.git)                                                      | Docker<br>Github<br>Google Gemini<br>Node.js<br>NPM<br>Python<br>VS Code<br>uv                                                                                                            |               |    | [Adaptation of the MCP Crash Course For Python Developers](https://www.youtube.com/watch?v=5xqFjh56AwM) |
...
| [Combination Encoder Decoder Tranformers to Summarize Documents with Text Clustering and Topic Modeling](https://github.com/beenlanced/combo_encoder_decoder_transformer)                                                      | Encoder<br>Decoder<br>Deep Learning<br>Github<br>HDBSCAN<br>Hugging Face<br>Jupyter<br>Latent Space<br>NLP<br>Numpy<br>Pandas<br>Python<br>Prompt Engineering<br>SBERT<br>Transformers<br>UMAP<br>uv                                                                                                            |               |    | AI Learning Module |
| [Semantic Search Application (end-to-end)](https://github.com/beenlanced/python_project_semantic_search)                                                      | AWS-ECS<br>Docker<br>FastAPI<br>Github<br>HTML<br>Hugging Face<br>Jupyter<br>NLP<br>Pytest<br>Python<br>Ruff<br>Scikit-learn<br>uv<br>YouTube API                                                                                                            |     AWS          |  FastAPI  | Cloud Computing<br>CI/CD (Github Actions)<br>Containerization<br>Data Validation<br>Error Handling<br>Linting<br>Model Registry<br>Model/Data Monitoring<br>Data Validation<br>Type Hinting |
| [Visualizing Latent Spaces](https://github.com/beenlanced/ai_learning_visualizing_latent_spaces)                                                      | Github<br>Jupyter<br>Keras<br>Matplotlib<br>MNIST<br>Numpy<br>Python<br>Scikit-learn<br>TensorFlow                                                                                                            |               |    | Learning Module for Review |
| **Data Analysis**                                                                                                                                                    |
...
| [Predict Bank Churn Using Neural Networks (NNs)](https://github.com/beenlanced/nn_bank_customer_churn)                                                      | AUC-ROC<br>Deep Learning<br>Dropout<br>Github<br>imblearn<br>Jupyter<br>Keras<br>Matplotlib<br>Numpy<br>Pandas<br>Python<br>Seaborn<br>Scikit-Learn<br>SMOTE<br>TensorFlow<br>uv                                                                                                            |               |    | Project from Post Graduate program in Artificial Intelligence and Machine Learning (PGAIML): Business Applications University of Texas at Austin Course |
| [Machine Learning Bank Fraud Detection](https://github.com/beenlanced/ml_bank_fraud_detection.git)                                                      |FacetGrid<br>Github<br>Isolation Foret<br>Jupyter<br>Numpy<br>Pandas<br>Python<br>Scikit-Learn<br>Seaborn<br>UV                                                                                                 |               |    | Learning Module for Practice/Review  |
| [Handling Imbalanced Data in Machine Learning Models](https://github.com/beenlanced/ml_handling_imbalanced_data.git)                                                      |Github<br>imblearn<br>Jupyter<br>Numpy<br>Pandas<br>Python<br>Scikit-Learn<br>SMOTE<br>Tomek                                                                                                 |               |    | Learning Module for Practice/Review  |
| [Predict The Fare of a Taxi Ride in Chicago Illinois](https://github.com/beenlanced/ml_predict_taxi_fares)                                                      | Deep Learning<Br>Github<br>Jupyter<br>Keras<br>Matplotlib<br>Numpy<br>Pandas<br>Plotly<br>Python<br>TensorFlow                                                                                                            |               |    | Learning Module for Google: Machine Learning Crash Course |
...
| **Miscellaneous**                                                                                                                                                    |
| [ML Mentoring - Understanding XGBoost Modeling, Calibration, and Feature Importance](https://github.com/beenlanced/ml_mentoring_xgboost.git)     |Calibration<br>Brier Score<br>EDA<br>Github<br>GridSearchCV<br>Jupyter<br>Matplotlib<br>Numpy<br>Pandas<br>Python<br>Seaborn<br>Scikit-learn<br>SHAP<br>uv<br>Tuning<br>Visual Studio Code<br>XGBoost |   |  |  Project for Mentoring in Data Science and Machine Learning |
| [ML Mentoring - Understanding the Importance of Calibrating Machine Learning Models](https://github.com/beenlanced/ml_mentoring_model_calibration_problem.git)     |Calibration<br>EDA<br>Github<br>Jupyter<br>Matplotlib<br>Numpy<br>Pandas<br>Python<br>Seaborn<br>Scikit-learn<br>uv<br>Visual Studio Code |   |  |  Project for Mentoring in Data Science and Machine Learning |
| [Generative AI: Introduction to Diffusion Models for Text Generation](https://github.com/beenlanced/ai_text_gen_diffusion_models.git)                                                      | Diffusion Models<br>Fine-Tuning<br>Github<br>Google Gemini<br>Hugging Face<br>Masked Language Models (MLM)<br>ModernBERT<br>Natural Language Generation (NLG)<br>Natural Language Processing (NLP)<br>Python<br>uv                                                                                                            |               |    | LinkedIn Learning Course [Generative AI: Introduction to Diffusion Models for Text Generation](https://www.linkedin.com/learning/generative-ai-introduction-to-diffusion-models-for-text-generation/what-is-natural-language-generation-29723010?autoSkip=true&resume=false&u=35754684) |
| [Python AsyncIO - How to Write Asynchronous Python Code](https://github.com/beenlanced/python_asyncio)                                                      | Github<br>Python<br>Ruff<br>uv                                                                                                            |               |    | Learning Asynchronous Python Coding |
| [Understanding Neural Network Matrix Algebra and Notation](https://github.com/beenlanced/nn_matrix_algebra)                                                      | Deep Learning<br>Github<br>Jupyter<br>Neural Networks<br>Matrix Algebra<br>Python<br>PyTorch<br>Tensors<br>uv                                                                                                            |               |    | Learning Module for Education and Meet-ups|
