...
- `Deep Learning (DL):` Convolutional Neural Networks (CNNs), Fine-Tuning, Generative Adversarial Networks, (GANs), Latent Space, Long Short-Term memory (LSTM), Model Compression (Knowledge Distillation, Pruning, and Quantization), Recurrent Neural Networks (RNNs), Transformers
